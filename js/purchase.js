...
selectedShipping == 0 && (deliveryMsg.innerText = 'Since you selected for no delivery, your purchase will be at the local waiting for you to pick up.')
selectedShipping == 300 && (deliveryMsg.innerText = 'Since you selected for a close delivery, your purchase will arrive to the area between 1 to 2 working days.')
selectedShipping == 800 && (deliveryMsg.innerText = 'Since you selected for a near delivery, your purchase will arrive to the area between 5 to 10 working days.')
selectedShipping == 1200 && (deliveryMsg.innerText = 'Since you selected for a far delivery, your purchase will arrive to the area between 10 to 15 working days.')
